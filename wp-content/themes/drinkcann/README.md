...
## Watching and compiling JavaScript and CSS files

`yarn watch` starts watching changes to files
`yarn build` creates production build

## Klaviyo

In order to keep the Klaviyo account secure, your Klaviyo API key must be stored in your wp-config.php file.

1. Locate your [Klaviyo API key](https://help.klaviyo.com/hc/en-us/articles/115005062267-How-to-Manage-Your-Account-s-API-Keys) in your Klaviyo account.
2. Connect to the WPEngine instance via [SFTP](https://wpengine.com/support/sftp/).
3. In the root of the file system of your website instance, located wp-config.php.
4. Locate the variable assignment KLAVIO_PRIVATE_API_KEY, and update the value with your Klaviyo API key.